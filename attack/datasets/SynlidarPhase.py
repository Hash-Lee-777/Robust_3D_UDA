...
ABSOLUTE_PATH = '/work/sdim-chenjj/workspace/Cosmix_Baseline/'
...
class AdvSynLidarTrain(BaseDataset):
    ...
    def get_splits(self):
        ...
        # 如果默认的split路径存在
            ...
            self.split,self.count_train_val = get_sum_split(split_path,'train')
...
class AdvSynlidarVal(BaseDataset):
    ...
    def get_splits(self):
        ...
        # 如果默认的split路径存在
            ...
            # self.split = torch.load(split_path)
            self.split,self.count_train_val = get_sum_split(split_path,'validation')
