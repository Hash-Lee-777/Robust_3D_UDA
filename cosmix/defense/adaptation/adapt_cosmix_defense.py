...
from utils.defense import SimMaskedAdaptationDefense
from utils.common.momentum import MomentumUpdater
from attack import AdvSynLidarTrain,AdvSynlidarVal,get_random_indices
import sys

parser = argparse.ArgumentParser()
parser.add_argument("--config_file",
                    default="configs/defense/uda/lidar2kitti.yaml",
                    type=str,
...
def adapt(config):
    ...
    source_training_dataset = AdvSynLidarTrain(
            ...
            adv_dataset_path=config.attack.adversarial_points_path,
            adv_gt_label=False,
...
if __name__ == '__main__':
    ...
    # 获取对抗样本所在地址
    adv_samples_path = config.attack.adversarial_points_path
    # 对抗样本采样比例
    adv_sample_rate = config.attack.adv_sample_rate
