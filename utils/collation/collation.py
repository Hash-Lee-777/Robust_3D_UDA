...
class CollateMerged:
    ...
    def __call__(self, list_data) -> dict:
        ...
        source_coordinates_batch, source_features_batch, source_labels_batch = ME.utils.SparseCollation(
            dtype=torch.float32,
            device=self.device)(source_list_data)

        target_coordinates_batch, target_features_batch, target_labels_batch = ME.utils.SparseCollation(
            dtype=torch.float32,
